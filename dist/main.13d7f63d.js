...
document.addEventListener("DOMContentLoaded", function () {//document.getElementById("body-home").addEventListener('click', btnClick)
  //$("#bar").hide()
  // $("#title-page").html("Home MC")
  //$("#buttons-pedido").hide()
});
var inputNome = document.getElementById("username");
var inputPswd = document.getElementById("password");
var mensagemL = document.getElementById("msn-login");
var senhaUser = document.getElementById("rs-user-senha");
var confSenhaUser = document.getElementById("rs-user-conf-senha");
